...
const Header: React.FC = () => {
  ...
  return (
    <header className="bg-card border-b border-primary/20 shadow-md fixed top-0 left-0 right-0 z-50">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex space-x-6 items-center">
            ...
            <div className="relative" ref={dbRef}>
              ...
              {activeDropdown === 'db' && (
                <div className="absolute left-0 mt-2 w-48 rounded-md shadow-lg bg-background border border-primary/30 ring-1 ring-black ring-opacity-5 z-[60]">
                  <div className="py-1">
                    <Link
                      to="/database/goods"
            ...
            <div className="relative" ref={calcRef}>
              ...
              {activeDropdown === 'calc' && (
                <div className="absolute left-0 mt-2 w-56 rounded-md shadow-lg bg-background border border-primary/30 ring-1 ring-black ring-opacity-5 z-[60]">
                  <div className="py-1">
                    <Link
      ...
      {/* Navigazione Mobile */}
      {isMobileMenuOpen && (
        <div className="md:hidden bg-background border-t border-primary/20 px-2 pt-2 pb-3 space-y-1 shadow-lg">
          <Link
            to="/"
