                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-3 gap-2 bg-background p-2.5 rounded border border-primary/10 text-center">
                    <div>
                      ...
                      <p className="text-sm font-semibold text-neutral-dark font-mono">{building.capacity.poor}</p>
                    </div>
                    <div>
                      <p className="text-3xs text-gray-600 font-bold uppercase">Benestanti</p>
                      <p className="text-sm font-semibold text-neutral-dark font-mono">{building.capacity.wealthy}</p>
                    </div>
                    <div>
                      <p className="text-3xs text-gray-600 font-bold uppercase">Ricchi</p>
                      <p className="text-sm font-semibold text-neutral-dark font-mono">{building.capacity.rich}</p>
                    </div>
                  </div>
                </div>
